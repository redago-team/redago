...
class WolneLekturyAPILoader:
    ...
    def fetch_books(self, limit=10, genre="epika", shuffle=True, directory="books"):
        ...
        for book in books:
            ...
            yield {
                'name': book_name,
                'content': processed_book.encode('utf-8')
            }

            limit -= 1

    def fetch_and_save_books(self, limit=10, genre="epika", shuffle=True, directory="books"):
...
if __name__=="__main__":
    ...
    loader.fetch_and_save_books(limit=10, genre="epika", shuffle=True, directory="books")